    ...
    <div>
      <nav className="fixed top-0 left-0 z-20 w-full border-b border-gray-200 bg-white py-3 px-6 sm:px-4">
        <div className="container mx-auto flex max-w-6xl flex-wrap items-center justify-around">
          ...
          <Link to={"/"}>
          <div className="flex">
           <span className="text-blue-400 font-extrabold text-xl border-t-4 border-dashed  pb-2">fake<span className="text-orange-700">Store</span></span>
          </div>
        </Link>
        </div>
        <div>
        <ul
          ...
          <li>
            ...
            <a href="#"
              ...
              <Link to={"/cart"}>
            <a href="#"
              class="block rounded py-2 pl-3 pr-4 text-gray-700 hover:bg-gray-100 md:p-0 md:hover:bg-transparent md:hover:text-blue-700">View Cart</a>
              </Link>
              <Link to={"/cart"}>
            <a href="#"
        ...
        <a href="#"
              class="block rounded py-2 pl-3 pr-4 text-gray-700 font-semibold hover:bg-gray-100 md:p-0 md:hover:bg-transparent md:hover:text-blue-700">Login</a>
        <a href="#"
              class="block rounded py-2 pl-3 pr-4 font-semibold text-gray-700 hover:bg-gray-100 md:p-0 md:hover:bg-transparent md:hover:text-blue-700">Register</a>
            </div>
        </div>
      </nav>
    </div>
